                        ...
                        @for($i=0; $i<count($options); $i++)
                            <div class="container border my-1 py-1 rounded">
                                ...
                                <div class="form-group">
                                    <input type="range" min="-9" max="9" class="form-control-range" name="value{{$i+1}}" disabled required >
                                </div>
                            </div>
                        @endfor
                    ...
                    <form method="POST" action="{{route('virtue.store')}}">
                        ...
                        @for($i=0; $i<count($options); $i++)
                            ...
                            <div class="container border my-1 py-1 rounded">
                                ...
                                <div class="form-group">
                                    <input type="range" min="-9" max="9" class="form-control-range" name="value{{$i+1}}" value="{{$options[$i]->virtue->value}}" disabled required >
                                </div>
                            </div>
                        @endfor
                    ...
                    <form method="POST" action="{{route('virtue.store')}}">
                        ...
                        @for($i=0; $i<count($stakeholders); $i++)
                            ...
                            <div class="container border my-1 py-1 rounded">
                                ...
                                <div class="form-group">
                                    <input type="range" min="-9" max="9" class="form-control-range" name="value{{$i+1}}" value="{{$stakeholders[$i]->virtue->value}}" disabled required >
                                </div>
                            </div>
                        @endfor
