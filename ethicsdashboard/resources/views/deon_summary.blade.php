        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{route('deontologysection.decision',$deontologySection->id)}}">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="decision" name="decision" rows="3" disabled placeholder="What option is the most morally correct one?">{{$deontologySection->decision}}</textarea>
                </div>
