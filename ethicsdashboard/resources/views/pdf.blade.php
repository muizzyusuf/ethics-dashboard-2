...
<html>
  ...
  <body>
    ...
    <table class="table table-bordered">
      ...
      <tr>
        <td>
          <h3>Ethical Issue: </h3>@if($ethicalIssue->issue != null) {{$ethicalIssue->issue}}@endif
        </td>
      </tr>
      <tr>
        <td>
          ...
          @for($i=0; $i<count($options); $i++)
            ...
            <p><b>Option {{$i+1}}: </b>{{$options[$i]->option}}</p>
              ...
              @for($j=0; $j<count($consequences); $j++)
                @if($consequences[$j]->option_id == $options[$i]->id)
                  <li style="margin-left:2em; padding-bottom: 0;">
                    @if($consequences[$j]->type=='long') 
                      <b>Long Term Consequence: </b>
                    @else 
                      <b>Short Term Consequence: </b>
                    @endif 
                    {{$consequences[$j]->consequence}}
      ...
      <tr>
        <td>
          ...
          @for($i=0; $i<count($stakeholders); $i++)
            ...
            <p><b>Stakeholder {{$i+1}}:</b> {{$stakeholders[$i]->stakeholder}}</p>
            <ol style="list-style-type: lower-alpha; padding-bottom: 0;">
              <li style="margin-left:2em; padding-bottom: 0;"><b>Interest:</b> {{$stakeholders[$i]->interests}}</li>
              @for($j=0; $j<count($impacts); $j++)
                @if($impacts[$j]->stakeholder_id==$stakeholders[$i]->id) 
                  <li style="margin-left:2em; padding-bottom: 0;"><b>Impact:</b> {{$impacts[$j]->impact}}</li>
                  <li style="margin-left:2em; padding-bottom: 0;"><b>Impact Rank:</b> {{$impacts[$j]->rank}}</li>
                @endif
              @endfor
            </ol>
          @endfor
      ...
      <tr>
        <td>
          ...
          <p><b>Decision:</b> {{$utilitarianism->decision}}</p>
          <small><b>*Aggregate Summary of Pleasure Analysis can be found Under the <em>Summary</em> tab on the Dashboard Page</b></small>
        </td>
      </tr>
      <tr>
        <td>
          ...
          @for($i=0; $i<count($oVirtues); $i+=2)
            @if($oVirtues[$i] != null)
              ...
              <p><b>Option: </b> {{$oVirtues[$i+1]->option}}</p>
              <ol style="list-style-type: lower-alpha; padding-bottom: 0;">
                <li style="margin-left:2em; padding-bottom: 0;"><b>Overall Virtue:</b> {{$oVirtues[$i]->virtue}}</li>
                <li style="margin-left:2em; padding-bottom: 0;"><b>Vice (Excess):</b> {{$oVirtues[$i]->excess}}</li>
                <li style="margin-left:2em; padding-bottom: 0;"><b>Virtue (Mean):</b> {{$oVirtues[$i]->mean}}</li>
                <li style="margin-left:2em; padding-bottom: 0;"><b>Vice (Deficiency):</b> {{$oVirtues[$i]->deficiency}}</li>
                <li style="margin-left:2em; padding-bottom: 0;"><b>Value:</b> {{$oVirtues[$i]->value}}</li>
              </ol>
            @endif
          @endfor
        </td>
      ...
      <tr>
        <td>
          ...
          @for($i=0; $i<count($sVirtues); $i+=2)
            @if($sVirtues[$i] != null)
              <p><b>Stakeholder:</b> {{$sVirtues[$i+1]->stakeholder}}</p>
              <ol style="list-style-type: lower-alpha; padding-bottom: 0;">
                <li style="margin-left:2em; padding-bottom: 0;"><b>Virtue:</b> {{$sVirtues[$i]->virtue}}</li>
                <li style="margin-left:2em; padding-bottom: 0;"><b>Vice (Excess):</b> {{$sVirtues[$i]->excess}}</li>
                <li style="margin-left:2em; padding-bottom: 0;"><b>Virtue (Mean):</b> {{$sVirtues[$i]->mean}}</li>
                <li style="margin-left:2em; padding-bottom: 0;"><b>Vice (Deficiency):</b> {{$sVirtues[$i]->deficiency}}</li>
                <li style="margin-left:2em; padding-bottom: 0;"><b>Value:</b> {{$sVirtues[$i]->value}}</li>
              </ol>
            @endif 
